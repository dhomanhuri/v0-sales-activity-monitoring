      ...
      <Card className="bg-slate-800 border-slate-700">
        <CardContent className="pt-6">
          {filteredTargets.length === 0 ? (
            <p className="text-center text-slate-400 py-8">Tidak ada data ditemukan</p>
          ) : (
            <div className="space-y-4">
              {filteredTargets.map((target: any) => {
                ...
                return (
                  <div
                    key={target.sales_id}
                    className="p-6 rounded-lg bg-slate-700 border border-slate-600"
                  >
                    <div className="mb-4">
                      <h3 className="font-semibold text-xl text-slate-50 mb-1">
                        {target.sales_name}
                      </h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div>
                        <p className="text-xs text-slate-400 mb-1">Target Revenue</p>
                      ...
                      <div>
                        <p className="text-xs text-slate-400 mb-1">Achievement Revenue</p>
