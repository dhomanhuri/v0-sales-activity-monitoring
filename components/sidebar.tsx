...
export function Sidebar({ user }: { user: any }) {
  ...
  return (
    <div className="w-64 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border-r border-slate-200/50 dark:border-slate-700/50 flex flex-col shadow-lg">
      <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-orange-100/80 to-orange-50/50 dark:from-slate-800 dark:to-slate-800">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-slate-700 dark:text-slate-300 hover:bg-gradient-to-r hover:from-orange-100 hover:to-orange-200 dark:hover:from-slate-700 dark:hover:to-slate-700 hover:text-orange-600 dark:hover:text-white hover:shadow-md hover:scale-[1.01]"
              )}
            >
      ...
      <div className="p-4 border-t border-slate-200/50 dark:border-slate-700/50 space-y-3 bg-gradient-to-t from-orange-50/50 to-transparent dark:from-slate-800 dark:to-transparent">
